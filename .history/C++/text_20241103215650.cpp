...
int main() {
    ...
    // 加载深度学习模型
    std::string protoFile = "path_to/colorization_deploy_v2.prototxt";
    std::string weightsFile = "path_to/colorization_release_v2.caffemodel";
    std::string ptsFile = "path_to/pts_in_hull.npy";
    ...
    // 保存或显示彩色图像
    cv::imwrite("path_to_save_color_image.jpg", labImage);
    cv::imshow("Color Image", labImage);
    cv::waitKey(0);
